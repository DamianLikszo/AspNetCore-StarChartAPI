...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        {
            var celetialObjects = _context.CelestialObjects.Where(x => x.Id == id || x.OrbitedObjectId == id);
            if (!celetialObjects.Any())
                return NotFound();

            _context.CelestialObjects.RemoveRange(celetialObjects);
            _context.SaveChanges();
